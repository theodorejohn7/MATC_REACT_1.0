...
export function SingleProduct({ id, image, title, description, netWeight, grossWeight, discPrice, price }: ProductItemProps) {

    const { getItemQuantity, increaseCartQuantity, decreaseCartQuantity, removeFromCart } = useShoppingCart()
    const quantity: number = getItemQuantity(id);

    return (
        <div style={{ height: '28rem' }} className="py-4  align-items-center justify-content-center d-flex  ">
            <Card
                key={id}
            ...
            >
                ...
                <Card.Footer className="d-flex">
                    ...
                    <div className="mt-auto w-100   ">
                        {quantity === 0 ? (
                            <Button className="  " onClick={() => increaseCartQuantity(id)}>Add to Cart</Button>
